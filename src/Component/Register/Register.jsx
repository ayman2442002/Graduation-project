...
export default function Register() {
 ...
 {formik.errors.email} 
  ...
  <div className="relative z-0 w-full mb-5 group">
      ...
      {formik.errors.phone && formik.touched.phone ?<div class="p-4 mb-4 text-sm text-red-600 " role="alert">
 {formik.errors.phone} 
</div>:null}
...
<button type="submit" className="text-white bg-emerald-600  focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">{isLoding? <i className=' fas fa-spinner fa-spin'></i> :"Register"}</button>
<Link to={"/login"}> 
